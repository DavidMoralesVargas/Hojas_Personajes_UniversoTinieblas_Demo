...
function mostrarVampiros() {
    return __awaiter(this, void 0, void 0, function* () {
        let vampiros = yield $.ajax({
        ...
        listaVampiros.forEach(vampiro => {
            ...
            filas += `<tr>
                    ...
                    <td><strong>Bane:</strong> ${((_a = vampiro.clanes_Banes[0]) === null || _a === void 0 ? void 0 : _a.bane) || "Sin debilidad de clan"} <br> <strong>Compulsión:</strong> ${((_b = vampiro.clanes_Banes[0]) === null || _b === void 0 ? void 0 : _b.compulsion) || "Sin compulsión de clan"}</td>
