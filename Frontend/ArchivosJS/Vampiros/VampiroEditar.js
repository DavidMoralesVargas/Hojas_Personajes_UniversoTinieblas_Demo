...
function buscarVampiro() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        $("#compulsion_vampiro").val(String((_a = vampiro.clanes_Banes[0]) === null || _a === void 0 ? void 0 : _a.compulsion));
        $("#bane_vampiro").val(String((_b = vampiro.clanes_Banes[0]) === null || _b === void 0 ? void 0 : _b.bane));
